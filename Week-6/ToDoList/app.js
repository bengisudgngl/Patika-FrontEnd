...
// toast:  ekranın belirli bir köşesinde belirli bir süre boyunca bir mesaj göstermek için kullanılır. 
function newElement() {
...
// Yapılanların üstüne checked at
function toggleChecked() {
    this.classList.toggle("checked");
    updateLocalStorage();
}

// Local Storage: Yaptığınız yapıya Local Storage'ı da ekleyip verilerin kaybolmamasını sağlayın.
